    ...
    <onboarding-tutorial
      ...
      <onboarding-page withimage>
        ...
        <div>
          ...
          <p>You can export your data to a file and share it with others.</p>
          ...
          <p class="legal-info">
            ...
            ARC uses Google Drive to list files created by the application when using "Open from Drive" option. It uploads requests, projects, or backup data to your Drive
            when you request it in the application UI.<br/>
            The application does not use Google Drive for anything else. The application does not store Google profile information.
          </p>
        </div>
      </onboarding-page>
      <onboarding-page withimage>
        ...
        <div>
          ...
          <p>
            RAML documentation viewer is a part of Mulesoft's API Console open source project.
          </p>
          <p>
      ...
      <onboarding-page withimage>
        ...
        <p>
          It is useful to debug virtual hosts configuration of your server, even when developing locally.
        </p>
      </onboarding-page>
      <onboarding-page withimage>
        ...
        <p>
          Log in to a web service using Chrome based built in web browser.
        </p>
        <p>
          Cookies are automatically applied to the request as browser would do it.
        </p>
        <p>
          Manage session cookies in the Request &gt; Web session menu.
        </p>
      </onboarding-page>
      <onboarding-page withimage>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              Google Drive file ID of files opened by the app are stored in the local history.
            </li>
            <li>
              (Chrome app only) Your settings are synced between your profiles,
              if you are signed in to Chrome, using Google Sync service for Chrome Apps.
            </li>
            <li>
              The app collects critical errors generated by the app, and sends them to Google Analytics.
              Data included in the report contains information about the exception itself (error message),
              and will not intentionally contain any user or user provided data.
            </li>
          </ul>
          <p>
